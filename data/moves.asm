...
MoveEnd:
	...
	move DOUBLESLAP,   TWO_TO_FIVE_ATTACKS_EFFECT,  18, NORMAL,    85, 10
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  25, ROCK,     100, 10
	...
	move RAZOR_WIND,   CHARGE_EFFECT,              120, POISON,   100, 10
	...
	move WRAP,         TRAPPING_EFFECT,             15, DRAGON,    85, 20
	move TAKE_DOWN,    RECOIL_EFFECT,               90, NORMAL,    85, 20
	move THRASH,       THRASH_PETAL_DANCE_EFFECT,  120, DRAGON,   100, 20
	move DOUBLE_EDGE,  RECOIL_EFFECT,              120, NORMAL,   100, 15
	move TAIL_WHIP,    DEFENSE_DOWN1_EFFECT,         0, NORMAL,   100, 30
	move POISON_STING, POISON_SIDE_EFFECT1,         30, POISON,   100, 35
	move TWINEEDLE,    TWINEEDLE_EFFECT,            35, POISON,   100, 20
	move PIN_MISSILE,  TWO_TO_FIVE_ATTACKS_EFFECT,  25, POISON,   100, 20
	...
	move BUBBLEBEAM,   SPEED_DOWN_SIDE_EFFECT,      75, WATER,    100, 20
	move AURORA_BEAM,  ATTACK_DOWN_SIDE_EFFECT,     75, ICE,      100, 20
	move HYPER_BEAM,   HYPER_BEAM_EFFECT,          150, NORMAL,    90,  5
	move PECK,         NO_ADDITIONAL_EFFECT,        35, FLYING,   100, 35
	move DRILL_PECK,   NO_ADDITIONAL_EFFECT,       100, FLYING,   100, 10
	move SUBMISSION,   NO_ADDITIONAL_EFFECT,       100, FIGHTING, 100,  5
	...
	move KINESIS,      ACCURACY_DOWN1_EFFECT,        0, PSYCHIC,  100, 15
	move SOFTBOILED,   HEAL_EFFECT,                  0, NORMAL,   100, 10
	move HI_JUMP_KICK, JUMP_KICK_EFFECT,            95, FIGHTING,  90, 20
	...
	move BARRAGE,      TWO_TO_FIVE_ATTACKS_EFFECT,  18, NORMAL,    85, 20
	...
	move DIZZY_PUNCH,  NO_ADDITIONAL_EFFECT,        75, NORMAL,   100, 10
	...
	move CRABHAMMER,   NO_ADDITIONAL_EFFECT,       100, BUG,      100, 10
