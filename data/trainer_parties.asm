...
; Route 3
	...
	db "WARREN@",17,PIDGEOTTO,-1
; Mt. Moon 1F
	db "JOSH@",17,RATICATE,IVYSAUR,BUTTERFREE,-1
; Route 24
	db "TIMMY@",22,IVYSAUR,WARTORTLE,CHARMELEON,-1
; Route 25
	db "CALVIN@",22,RATICATE,SPEAROW,-1
	db "DAN@",23,DITTO,-1
	db "CHAD@",22,ARBOK,SANDSLASH,-1
; SS Anne 1F Rooms
	db "TYLER@",25,NIDORINO,-1
; Route 11
	db "EDDIE@",25,ARBOK,-1
	db "DILLON@",24,SANDSLASH,GOLBAT,-1
	db "YASU@",25,TAUROS,WARTORTLE,RATICATE,-1
	db "DAVE@",24,NIDOQUEEN,DEWGONG,-1

BugCatcherData:
; Viridian Forest
	db "RICK@",9,WEEDLE,CATERPIE,-1
	db "DOUG@",8,KRABBY,VENONAT,PARAS,-1
	db "SAMMY@",10,BEEDRILL,-1
; Route 3
	db "RICK@",15,BUTTERFREE,PARAS,BEEDRILL,-1
	db "GREG@",14,PINSIR,KAKUNA,PARAS,SCYTHER,-1
	db "JAMES@",16,BUTTERFREE,KRABBY,-1
; Mt. Moon 1F
	db "KENT@",17,PINSIR,BEEDRILL,-1
	db "ROBBY@",18,KABUTO,SCYTHER,TANGELA,-1
; Route 24
	db "CALE@",19,SCYTHER,PINSIR,-1
; Route 6
	db "KEIGO@",24,BEEDRILL,BUTTERFREE,PARASECT,-1
	db "ELIJAH@",90,WEEDLE,-1
; Unused
	db "X@",5,BULBASAUR,-1
; Route 9
...
LassData:
; Route 3
	db "JANICE@",16,SEEL,EEVEE,-1
	db "SALLY@",16,STARYU,NIDORINO,-1
	db "ROBIN@",17,JIGGLYPUFF,-1
; Route 4
	db "CRISSY@",40,TAUROS,JYNX,PARASECT,-1
; Mt. Moon 1F
	db "MIRIAM@",18,GOLDEEN,HORSEA,-1
	db "IRIS@",18,CLEFAIRY,-1
; Route 24
	db "ALI@",21,GLOOM,NIDORINO,-1
	db "RELI@",22,STARYU,NIDORINA,-1
; Route 25
	db "KELSEY@",23,POLIWAG,GROWLITHE,-1
	db "HALEY@",23,WEEPINBELL,VULPIX,PIDGEOTTO,-1
; SS Anne 1F Rooms
...
SailorData:
; SS Anne Stern
	db "EDMOND@",28,DEWGONG,HITMONCHAN,-1
	db "TREVOR@",28,STARMIE,TENTACRUEL,-1
; SS Anne B1F Rooms
	db "LEONARD@",29,CLOYSTER,-1
	db "DUNCAN@",27,SEADRA,DRAGONAIR,TENTACRUEL,-1
	db "HUEY@",28,GOLDUCK,HYPNO,-1
	db "DYLAN@",27,GYARADOS,GYARADOS,GYARADOS,-1
	db "PHILLIP@",29,MACHAMP,-1
; Vermilion Gym
	db "DWAYNE@",35,ELECTRODE,POLIWRATH,-1

JrTrainerMData:
; Pewter Gym
	db "JERRY@",13,CUBONE,DIGLETT,-1
; Route 24
	db "SHANE@",22,MANKEY,CUBONE,-1
; Route 24
	db "ETHAN@",21,GOLDUCK,-1
; Route 6
	db "RICKY@",24,SEEL,-1
	db "JEFF@",24,NIDOKING,NIDOQUEEN,-1
; Route 25
...
JrTrainerFData:
; Cerulean Gym
	db "DIANA@",25,SEADRA,-1
; Route 6
	db "NANCY@",23,PONYTA,RAICHU,-1
...
SuperNerdData:
; Mt. Moon 1F
	db "JOVAN@",18,MAGNEMITE,VOLTORB,-1
; Mt. Moon B2F
	db "MIGUEL@",19,JYNX,MAGMAR,ELECTABUZZ,-1
; Route 8
...
HikerData:
; Mt. Moon 1F
	db "MARCOS@",18,RHYHORN,HITMONLEE,ONIX,-1
; Route 25
	db "FRANKLIN@",22,WIGGLYTUFF,RHYHORN,-1
	db "NOB@",22,FARFETCHD,SANDSHREW,LICKITUNG,ONIX,-1
	db "WAYNE@",23,LAPRAS,-1
; Route 9
...
; Unused
	db "X@",5,BULBASAUR,-1
; Route 11
	db "BRAXTON@",27,JOLTEON,-1
	db "BERNIE@",26,PORYGON,ELECTRODE,MAGNETON,-1
...
GamblerData:
; Route 11
	db "HUGO@",26,POLIWAG,PORYGON,-1
	db "JASPER@",25,NINETALES,RAPIDASH,-1
	db "DIRK@",25,SEAKING,MAGNETON,-1
	db "DARIAN@",26,ARCANINE,DUGTRIO,-1
; Route 8
...
Giovanni2Data:
; Rocket Hideout B4F
	db "GIOVANNI@",LEVELS,37,PERSIAN,37,DUGTRIO,37,NIDOKING,38,KANGASKHAN,-1
; Silph Co. 11F
	db "GIOVANNI@",LEVELS,49,PERSIAN,49,NIDOQUEEN,49,GENGAR,49,ALAKAZAM,50,ZAPDOS,-1
; Viridian Gym
	db "GIOVANNI@",MOVES
...
RocketData:
; Mt. Moon B2F
	db "GRUNT@",19,KADABRA,GOLBAT,-1
	db "GRUNT@",18,ARBOK,DITTO,DRATINI,-1
	db "GRUNT@",20,HAUNTER,IVYSAUR,-1
	db "GRUNT@",20,RATICATE,-1
; Cerulean City
	db "GRUNT@",25,PERSIAN,DITTO,-1
; Route 24
	db "GRUNT@",25,MRMIME,DUGTRIO,-1
; Game Corner
	db "GRUNT@",28,RATICATE,GENGAR,-1
; Rocket Hideout B1F
	db "GRUNT@",26,DROWZEE,GOLBAT,-1
	db "GRUNT@",25,RATICATE,RATICATE,-1
	db "GRUNT@",26,HAUNTER,KOFFING,CUBONE,-1
	db "GRUNT@",25,ONIX,HAUNTER,HAUNTER,SEEL,-1
	db "GRUNT@",27,GOLBAT,PONYTA,-1
; Rocket Hideout B2F
	db "GRUNT@",27,GOLBAT,ELECTABUZZ,MAGMAR,KADABRA,RATICATE,-1
; Rocket Hideout B3F
...
; Silph Co. 5F
	...
	db "GRUNT@",37,HYPNO,-1
; Silph Co. 6F
	db "GRUNT@",37,GOLBAT,MACHOKE,-1
	db "GRUNT@",36,HAUNTER,ARBOK,GOLBAT,-1
; Silph Co. 7F
	db "GRUNT@",37,RATICATE,ARBOK,KOFFING,GOLBAT,-1
	db "GRUNT@",36,MAGMAR,MAROWAK,-1
	db "GRUNT@",37,TAUROS,SANDSLASH,-1
; Silph Co. 8F
	db "GRUNT@",36,RATICATE,BEEDRILL,GOLBAT,BLASTOISE,-1
	db "GRUNT@",38,WEEZING,GOLBAT,MUK,-1
; Silph Co. 9F
	db "GRUNT@",36,HYPNO,MUK,PIDGEOT,-1
	db "GRUNT@",35,GOLBAT,LAPRAS,HYPNO,-1
; Silph Co. 10F
...
CooltrainerMData:
; Viridian Gym
	db "SAUL@",50,SANDSLASH,ARBOK,RHYHORN,NIDOQUEEN,NIDOKING,-1
; Victory Road 3F
	db "BEN@",60,VICTREEBEL,DRAGONITE,LAPRAS,RAICHU,ARCANINE,-1
...
; Unused
	...
	db "X@",5,BULBASAUR,-1
; Viridian Gym
	db "YUJI@",50,SANDSLASH,GOLEM,ONIX,DUGTRIO,MAROWAK,-1
	db "WREN@",50,VENUSAUR,LAPRAS,RHYHORN,RAICHU,ARCANINE,-1

CooltrainerFData:
; Celadon Gym
	db "MARY@",32,NINETALES,TANGELA,NIDOKING,-1
; Victory Road 3F
...
; Unused
	db "X@",5,BULBASAUR,-1
; Victory Road 1F
	db "NAOMI@",60,DITTO,JOLTEON,DRAGONITE,STARMIE,NINETALES,-1
...
BrockData:
	db "BROCK@",MOVES
		db 15,GOLEM,EXPLOSION,ROCK_SLIDE,NO_MOVE,NO_MOVE
		db 15,KABUTO,WATERFALL,ROCK_SLIDE,ICE_BEAM,NO_MOVE
		db 15,OMANYTE,ABSORB,BUBBLEBEAM,ICE_BEAM,NO_MOVE
		db 15,ONIX,BODY_SLAM,DIG,ROCK_SLIDE,NO_MOVE
	db -1

MistyData:
	db "MISTY@",MOVES
		db 26,VAPOREON,ICE_BEAM,SURF,SAND_ATTACK,RECOVER
		db 26,POLIWRATH,ICE_BEAM,SURF,LOVELY_KISS,EARTHQUAKE
		db 26,DRAGONAIR,WATERFALL,THUNDER_WAVE,RECOVER,WRAP
		db 26,STARMIE,THUNDER_WAVE,RECOVER,SURF,PSYCHIC_M
	db -1
...
GentlemanData:
; SS Anne 1F Rooms
	db "THOMAS@",27,ARCANINE,RAPIDASH,-1
	db "ARTHUR@",27,NIDOKING,NIDOQUEEN,-1
; SS Anne 2F Rooms
	db "BROOKS@",28,RAICHU,-1
; Vermilion Gym
	db "TUCKER@",34,TANGELA,MAGNETON,-1
; SS Anne 2F Rooms
	db "LAMAR@",28,LAPRAS,SNORLAX,-1

Green2Data:
; SS Anne 2F
	db "<RIVAL>@",LEVELS,30,VAPOREON,30,JOLTEON,30,FLAREON,32,MEW,-1
	db "<RIVAL>@",LEVELS,30,VAPOREON,30,JOLTEON,30,FLAREON,32,MEW,-1
	db "<RIVAL>@",LEVELS,30,VAPOREON,30,JOLTEON,30,FLAREON,32,MEW,-1
; Pokémon Tower 2F
