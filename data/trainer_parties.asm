...
; Mt. Moon 1F
	db "JOSH@",16,RATTATA,BULBASAUR,ZUBAT,-1
; Route 24
...
Giovanni2Data:
; Rocket Hideout B4F
	db "GIOVANNI@",LEVELS,35,PERSIAN,35,DUGTRIO,35,KANGASKHAN,-1
; Silph Co. 11F
	db "GIOVANNI@",LEVELS,47,PERSIAN,47,GENGAR,47,ALAKAZAM,47,ZAPDOS,-1
; Viridian Gym
	db "GIOVANNI@",MOVES
		db 56,PERSIAN,BUBBLEBEAM,THUNDERBOLT,HYPNOSIS,BODY_SLAM
		db 56,DUGTRIO,BODY_SLAM,SAND_ATTACK,FISSURE,EARTHQUAKE
		db 56,GENGAR,HYPNOSIS,PSYCHIC_M,EXPLOSION,THUNDERBOLT
		db 56,ZAPDOS,THUNDER_WAVE,THUNDERBOLT,DRILL_PECK,AGILITY
...
BrunoData:
	db "BRUNO@",MOVES
		db 66,ZAPDOS,THUNDERBOLT,THUNDER_WAVE,DRILL_PECK,AGILITY
		...
		db 67,CHARIZARD,FIRE_BLAST,EARTHQUAKE,HYPER_BEAM,SWORDS_DANCE
	db -1

BrockData:
	db "BROCK@",MOVES
		db 15,OMANYTE,ROCK_THROW,BUBBLEBEAM,NO_MOVE,NO_MOVE
		db 16,ONIX,BODY_SLAM,DIG,ROCK_THROW,BIND
	db -1

MistyData:
	db "MISTY@",MOVES
		db 24,VAPOREON,ICE_BEAM,SURF,SAND_ATTACK,BODY_SLAM
		db 24,STARMIE,THUNDER_WAVE,RECOVER,SURF,PSYCHIC_M
	db -1
...
ErikaData:
	db "ERIKA@",MOVES
		...
		db 35,VENUSAUR,BODY_SLAM,SLEEP_POWDER,SWORDS_DANCE,RAZOR_LEAF
	db -1

KogaData:
	db "KOGA@",MOVES
		db 47,GENGAR,HYPNOSIS,PSYCHIC_M,NIGHT_SHADE,EXPLOSION
		db 47,NIDOKING,LOVELY_KISS,EARTHQUAKE,THUNDERBOLT,BLIZZARD
		db 47,VENOMOTH,TOXIC,LEECH_LIFE,STUN_SPORE,PSYCHIC_M
		db 47,WEEZING,FIRE_BLAST,THUNDERBOLT,SMOKESCREEN,SLUDGE
	db -1

BlaineData:
	db "BLAINE@",MOVES
		db 53,CHARIZARD,FIRE_BLAST,EARTHQUAKE,SWORDS_DANCE,HYPER_BEAM
		db 53,NINETALES,PSYCHIC_M,CONFUSE_RAY,FLAMETHROWER,HYPNOSIS
		db 53,TAUROS,EARTHQUAKE,DOUBLE_EDGE,FIRE_SPIN,BLIZZARD
		db 53,ARCANINE,MIMIC,BODY_SLAM,AGILITY,FIRE_BLAST
	db -1

SabrinaData:
	db "SABRINA@",MOVES
		db 49,JYNX,PSYCHIC_M,BLIZZARD,LOVELY_KISS,BODY_SLAM
		db 49,SLOWBRO,SURF,THUNDER_WAVE,AMNESIA,PSYCHIC_M
		db 49,GENGAR,HYPNOSIS,NIGHT_SHADE,THUNDERBOLT,PSYCHIC_M
		db 49,ALAKAZAM,SEISMIC_TOSS,RECOVER,PSYCHIC_M,THUNDER_WAVE
	db -1
...
Green2Data:
; SS Anne 2F
	db "<RIVAL>@",LEVELS,25,FLAREON,25,JOLTEON,25,FLAREON,25,MEW,-1
...
; Pokémon Tower 2F
	db "<RIVAL>@",LEVELS,32,PIDGEOT,32,GOLEM,32,VENUSAUR,32,GENGAR,32,MEW,-1
...
; Silph Co. 7F
	db "<RIVAL>@",LEVELS,45,DODRIO,45,ARCANINE,45,EXEGGUTOR,45,GYARADOS,45,MEW,-1
...
; Route 22
	db "<RIVAL>@",LEVELS,58,JOLTEON,58,RHYDON,58,ARCANINE,58,EXEGGUTOR,58,STARMIE,58,MEW,-1
...
Green3Data:
	db "<RIVAL>@",MOVES
		db 72,MEW,PSYCHIC_M,SOFTBOILED,THUNDER_WAVE,BODY_SLAM
		db 72,JOLTEON,THUNDERBOLT,THUNDER_WAVE,BODY_SLAM,SAND_ATTACK
		db 72,RHYDON,EARTHQUAKE,ROCK_SLIDE,HORN_DRILL,BODY_SLAM
		db 72,ARCANINE,BODY_SLAM,REFLECT,FIRE_BLAST,HYPER_BEAM
		db 72,STARMIE,THUNDERBOLT,PSYCHIC_M,RECOVER,BLIZZARD
	...
	db "<RIVAL>@",MOVES
		...
		db 72,ARCANINE,BODY_SLAM,REFLECT,FIRE_BLAST,HYPER_BEAM
		db 72,STARMIE,THUNDERBOLT,PSYCHIC_M,RECOVER,BLIZZARD
		db 72,MEWTWO,PSYCHIC_M,THUNDER_WAVE,BODY_SLAM,RECOVER
	db -1
...
AgathaData:
	db "AGATHA@",MOVES
		db 67,GENGAR,NIGHT_SHADE,EXPLOSION,HYPNOSIS,THUNDERBOLT
...
LanceData:
	db "LANCE@",MOVES
		db 70,KANGASKHAN,HYPER_BEAM,SURF,BODY_SLAM,EARTHQUAKE
		db 70,LAPRAS,THUNDERBOLT,BLIZZARD,SURF,BODY_SLAM
		db 70,SNORLAX,LOVELY_KISS,HYPER_BEAM,BODY_SLAM,EARTHQUAKE
		db 70,MOLTRES,SKY_ATTACK,AGILITY,FIRE_BLAST,HYPER_BEAM
		db 70,DRAGONITE,BLIZZARD,WRAP,THUNDER_WAVE,HYPER_BEAM
	db -1
