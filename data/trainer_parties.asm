...
RocketData:
; Mt. Moon B2F
	db "GRUNT@",14,ABRA,DROWZEE,-1
	db "GRUNT@",14,SANDSHREW,DITTO,ZUBAT,-1
...
BrockData:
	db "BROCK@",MOVES
		db 13,OMANYTE,ROCK_THROW,BUBBLEBEAM,AURORA_BEAM,NO_MOVE
		db 13,KABUTO,WATERFALL,SLASH,AURORA_BEAM,NO_MOVE
		db 14,ONIX,BODY_SLAM,DIG,ROCK_THROW,NO_MOVE
	db -1
