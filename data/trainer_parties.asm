...
BlaineData:
	db "BLAINE@",MOVES
		...
		db 53,ARCANINE,MIMIC,BODYSLAM,AGILITY,FIRE_BLAST
	db -1
...
; Pokémon Tower 2F
	...
	db "<RIVAL>@",LEVELS,30,PIDGEOTTO,29,GYARADOS,29,GROWLITHE,30,ALAKAZM,32,IVYSAUR,-1
	db "<RIVAL>@",LEVELS,30,PIDGEOTTO,29,EXEGGCUTE,29,GYARADOS,30,ALAKZAM,32,CHARMELEON,-1
; Silph Co. 7F
...
Green3Data:
	db "<RIVAL>@",MOVES
		...
		db 70,JOLTEON,THUNDERBOLT,THUNDERWAVE,BODY_SLAM,SAND_ATTACK
...
AgathaData:
	db "AGATHA@",MOVES
		...
		db 67,ALAKAZAM,THUNDER_WAVE,RECOVER,PSYCHIC_M,FIREPUNCH
