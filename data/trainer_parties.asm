...
; Cinnabar Gym
	...
	db "DUSTY@",42,ARCANINE,RAPIDASH,-1
; Mansion 2F
	db "ARNIE@",39,SANDSLASH,CHARIZARD,-1
; Mansion 3F
	db "SIMON@",42,NINETALES,-1
; Mansion B1F
	db "LEWIS@",39,GOLEM,RAPIDASH,-1
...
Giovanni2Data:
; Rocket Hideout B4F
	db "GIOVANNI@",LEVELS,35,PERSIAN,35,DUGTRIO,37,KANGASKHAN,-1
; Silph Co. 11F
	db "GIOVANNI@",LEVELS,47,PERSIAN,47,GENGAR,47,ALAKAZAM,50,ZAPDOS,-1
; Viridian Gym
	db "GIOVANNI@",MOVES
...
BrunoData:
	db "BRUNO@",MOVES
		db 70,ZAPDOS,THUNDERBOLT,THUNDER_WAVE,DRILL_PECK,AGILITY
...
BrockData:
	db "BROCK@",MOVES
		db 16,OMANYTE,ROCK_THROW,BUBBLEBEAM,AURORA_BEAM,NO_MOVE
...
LtSurgeData:
	db "LT.SURGE@",MOVES
		...
		db 29,RAICHU,THUNDER_WAVE,BODY_SLAM,SURF,THUNDERBOLT
	db -1
...
ErikaData:
	db "ERIKA@",MOVES
		...
		db 38,VENUSAUR,BODY_SLAM,SLEEP_POWDER,SWORDS_DANCE,RAZOR_LEAF
	db -1
...
BlaineData:
	db "BLAINE@",MOVES
		...
		db 57,ARCANINE,MIMIC,BODY_SLAM,AGILITY,FIRE_BLAST
	db -1
...
SabrinaData:
	db "SABRINA@",MOVES
		...
		db 53,ALAKAZAM,SEISMIC_TOSS,RECOVER,PSYCHIC_M,THUNDER_WAVE
	db -1
...
Green3Data:
	db "<RIVAL>@",MOVES
		db 73,MEW,PSYCHIC_M,SOFTBOILED,THUNDER_WAVE,BODY_SLAM
		db 73,JOLTEON,THUNDERBOLT,THUNDER_WAVE,BODY_SLAM,SAND_ATTACK
		db 73,RHYDON,EARTHQUAKE,ROCK_SLIDE,HORN_DRILL,BODY_SLAM
	...
	db "<RIVAL>@",MOVES
		...
		db 73,ARCANINE,BODY_SLAM,REFLECT,FIRE_BLAST,HYPER_BEAM
		db 73,STARMIE,THUNDERBOLT,PSYCHIC_M,RECOVER,BLIZZARD
		db 75,MEWTWO,PSYCHIC_M,THUNDER_WAVE,BODY_SLAM,RECOVER
	db -1
...
LoreleiData:
	db "LORELEI@",MOVES
		...
		db 70,ARTICUNO,BLIZZARD,SKY_ATTACK,REFLECT,AGILITY
	db -1
...
AgathaData:
	db "AGATHA@",MOVES
		db 70,GENGAR,NIGHT_SHADE,EXPLOSION,HYPNOSIS,THUNDERBOLT
		db 70,TENTACRUEL,SURF,BLIZZARD,TOXIC,WRAP
		db 70,ALAKAZAM,THUNDER_WAVE,RECOVER,PSYCHIC_M,FIRE_PUNCH
		db 70,ARBOK,WRAP,GLARE,EARTHQUAKE,TOXIC
		db 70,GENGAR,HYPNOSIS,PSYCHIC_M,THUNDERBOLT,MEGA_DRAIN
	db -1

LanceData:
	db "LANCE@",MOVES
		db 72,KANGASKHAN,HYPER_BEAM,SURF,BODY_SLAM,EARTHQUAKE
		db 72,LAPRAS,THUNDERBOLT,BLIZZARD,SURF,BODY_SLAM
		db 72,SNORLAX,LOVELY_KISS,HYPER_BEAM,BODY_SLAM,EARTHQUAKE
		db 72,MOLTRES,SKY_ATTACK,AGILITY,FIRE_BLAST,HYPER_BEAM
		db 72,DRAGONITE,BLIZZARD,WRAP,THUNDER_WAVE,HYPER_BEAM
	db -1
