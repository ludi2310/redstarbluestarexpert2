...
ErikaData:
	db "ERIKA@",MOVES
		...
		db 37,VENUSAUR,BODY_SLAM,SLEEP_POWDER,SWORDS_DANCE,RAZOR_LEAF
	db -1

KogaData:
	db "KOGA@",MOVES
		db 47,GENGAR,HYPNOSIS,PSYCHIC_M,NIGHT_SHADE,EXPLOSION
		db 47,TENTACRUEL,SURF,ICE_BEAM,WRAP,REST
...
LoreleiData:
	db "LORELEI@",MOVES
		...
		db 70,VAPOREON,HYDRO_PUMP,SAND_ATTACK,BLIZZARD,BODY_SLAM
...
LanceData:
	db "LANCE@",MOVES
		...
		db 72,AERODACTYL,SKY_ATTACK,EARTHQUAKE,ROCK_SLIDE,SWORDS_DANCE
		db 72,SEADRA,SURF,BLIZZARD,SMOKESCREEN,DOUBLE_EDGE
